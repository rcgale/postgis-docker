...
load_national_data () {
    table_exists "tiger_data" "state_all" || (
      cd $GISDATA
    ...
    table_exists "tiger_data" "county_all" || (
      cd $GISDATA
...
load_state_data () {
    ...
    # Place
    #############
    table_exists "tiger_data" "${abbr}_place" || (
      cd $GISDATA
    ...
    # Cousub
    #############
    table_exists "tiger_data" "${abbr}_cousub" || (
      cd $GISDATA
    ...
    # Tract
    #############
    table_exists "tiger_data" "${abbr}_tract" || (
      cd $GISDATA
    ...
    # Faces
    #############
    table_exists "tiger_data" "${abbr}_faces" || (
      cd $GISDATA
    ...
    # FeatNames
    #############
    table_exists "tiger_data" "${abbr}_featnames" || (
      cd $GISDATA
    ...
    # Addr
    #############
    table_exists "tiger_data" "${abbr}_addr" || (
      cd $GISDATA
